...
switch(true)
{
   ...
   break;
   case (n1<=50) :document.form1.resultado.value=n1=n1=3900;
    break; // rompo el ciclo para que se salga del switch
   case (n1>=51) :document.form1.resultado.value=n1=n1*78; break;
...
if (form1.nocturno.checked == true)
  {
  document.form1.resultado.value=n1=n1+1900;
  }
if (form1.aeropuerto.checked == true)
  {
  document.form1.resultado.value=n1=n1+3900;
  }
if (form1.puerta.checked == true)
  {
  document.form1.resultado.value=n1=n1+700;
  }
